package com.example.movietrailers.movie_details
...
import com.example.movietrailers.databinding.FragmentMovieDetailBinding
import com.example.movietrailers.movies.MoviesFragmentDirections
import com.example.movietrailers.utils.EventObserver
...
class MovieDetailFragment : Fragment() {
    ...
    private val movieDetailViewModel by viewModels<MovieDetailViewModel> {
        MovieDetailViewModelFactory((requireActivity().applicationContext as movietrailersApplication).movieRepository)
    }
