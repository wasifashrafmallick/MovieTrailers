package com.example.movietrailers.movies
...
import com.example.movietrailers.databinding.FragmentMoviesBinding
...
class MoviesFragment : Fragment() {
    ...
    private val  movieViewModel by viewModels<MoviesViewModel> {
        MovieViewModelFactory((requireActivity().applicationContext as movietrailersApplication).movieRepository)
    }
